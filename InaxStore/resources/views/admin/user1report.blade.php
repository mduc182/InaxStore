                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <a href="{{ Route('ureport') }}"><h5 style="color:green; font-family:Roboto; font-weight:bold;">Tổng NV </h5></a>
                                                <br>
                                                {{ $user_count }}
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <a href="{{ Route('u1report') }}"><h5 style="color:blue; font-family:Roboto; font-weight:bold;">Số NV Nhập Đơn</h5></a>
                                                <br>
                                             {{ $user_nv }} 
                                        </div>
                                        <div class="col-auto">
