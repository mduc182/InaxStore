                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <a href="{{ Route('breport') }}"><h5 style="color:green; font-family:Roboto; font-weight:bold;">Tổng Đơn Nhập </h5></a>
                                                <br>
                                                {{ $bill_count }}
                        ...
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <a href="{{ Route('b1report') }}"><h5 style="color:blue; font-family:Roboto; font-weight:bold;">Đơn Ngày Hôm Nay</h5></a>
                                                <br>
                                             {{ $bill_today }}
                                        </div>
                                        <div class="col-auto">
