                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <a href="{{ Route('preport') }}"><h5 style="color:blue; font-family:Roboto; font-weight:bold;">Tổng Sản Phẩm </h5></a>
                                                <br>
                                                {{ $product_count }}
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                    <a href="{{ Route('p3report') }}"><h5 style="color:green; font-family:Roboto; font-weight:bold;">Loại Phụ Kiện</h5></a>
                                                <br>
                                                {{ $product_pk }}
